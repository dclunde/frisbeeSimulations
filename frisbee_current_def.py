...
def plot_frisbee(i,Fancy=False,html_mpld3=False,html_bokeh=False,html_plotly=False,\
    gif=False,ground=False,step=False,rotate=False,follow=False,target=False,Field=False,**kwargs):
...
def make_target(ax,center):
    if not len(center) == 3:
        print "Input a input point in the [x,y,z] format"
        return
    
    ax.scatter(center[2],center[0],center[1], color='g')
